...
public class KThread {
    ...
    public KThread() {
        ...
        //joinQueue = new nachos.threads.PriorityScheduler().new PriorityQueue(true);
    }
    ...
    public static void finish() {
        ...
        /*if (currentThread.joinQueue != null) {
            KThread j = currentThread.joinQueue.nextThread();
            if (j != null)
                j.ready();  
        }*/
     ...
     * a <tt>Semaphore</tt>, <tt>Lock</tt>, or <tt>Condition2</tt>), eventually
    ...
    public void join() {
        ...
        if (joinCount > 0) {
            System.out.println("WARNING: Joined twice");
            return;
        }
        ...
        joinQueue.waitForAccess(currentThread);//将当前线程加入到waitForJoinQueue队列里
    ...
    public static void selfTest() {
        ...
        /*KThread forked = new KThread(new PingTest(1));
        forked.setName("forked thread").fork();
        forked.join();
        new PingTest(0).run();*/
    ...
    //private nachos.threads.PriorityScheduler.PriorityQueue joinQueue = new nachos.threads.PriorityScheduler.PriorityQueue(false);
